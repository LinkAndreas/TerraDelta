...
export const STRINGS = {
  en: {
    ...
    "obj.schiffsverkehr": "Shipping traffic",
    ...
    "cat.schiffsverkehr.anleger": "landing stage",
    "cat.schiffsverkehr.autofaehre": "car ferry",

    "obj.gebaeude": "Buildings",
    "obj.tatsaechliche_nutzung": "Actual land use",
    "obj.vegetation": "Vegetation",
    "obj.gewaesser": "Water bodies",
    "obj.verkehr": "Minor roads/paths",
    "obj.bauwerke": "Structures",
    "obj.siedlung": "Settlement areas",
    "obj.versorgung": "Utilities",
    "obj.bahn": "Rail infrastructure",
    "obj.relief": "Terrain",

    "cat.gebaeude.wohngebaeude": "residential building",
    "cat.gebaeude.geschaeftsgebaeude": "commercial building",
    "cat.gebaeude.industriegebaeude": "industrial building",
    "cat.gebaeude.lagerhalle": "warehouse",
    "cat.gebaeude.garage": "garage",
    "cat.gebaeude.carport": "carport",
    "cat.gebaeude.nebengebaeude": "outbuilding",
    "cat.gebaeude.schuppen": "shed",
    "cat.gebaeude.gewaechshaus": "greenhouse",
    "cat.gebaeude.kirche": "church",
    "cat.gebaeude.schule": "school",
    "cat.gebaeude.krankenhaus": "hospital",
    "cat.gebaeude.sporthalle": "sports hall",
    "cat.tatsaechliche_nutzung.acker": "cropland",
    "cat.tatsaechliche_nutzung.gruenland": "grassland",
    "cat.tatsaechliche_nutzung.wiese": "meadow",
    "cat.tatsaechliche_nutzung.weide": "pasture",
    "cat.tatsaechliche_nutzung.obstplantage": "orchard",
    "cat.tatsaechliche_nutzung.weinberg": "vineyard",
    "cat.tatsaechliche_nutzung.baumschule": "tree nursery",
    "cat.tatsaechliche_nutzung.wald": "forest",
    "cat.tatsaechliche_nutzung.laubwald": "deciduous forest",
    "cat.tatsaechliche_nutzung.nadelwald": "coniferous forest",
    "cat.tatsaechliche_nutzung.mischwald": "mixed forest",
    "cat.tatsaechliche_nutzung.heide": "heathland",
    "cat.tatsaechliche_nutzung.moor": "moor",
    "cat.tatsaechliche_nutzung.sumpf": "swamp",
    "cat.tatsaechliche_nutzung.brachflaeche": "fallow land",
    "cat.tatsaechliche_nutzung.garten": "garden",
    "cat.tatsaechliche_nutzung.parkanlage": "park",
    "cat.vegetation.einzelbaum": "single tree",
    "cat.vegetation.baumgruppe": "tree group",
    "cat.vegetation.baumreihe": "tree row",
    "cat.vegetation.hecke": "hedge",
    "cat.vegetation.gebuesch": "shrubbery",
    "cat.vegetation.gehoelz": "copse",
    "cat.gewaesser.fluss": "river",
    "cat.gewaesser.bach": "stream",
    "cat.gewaesser.see": "lake",
    "cat.gewaesser.weiher": "pond",
    "cat.gewaesser.teich": "small pond",
    "cat.gewaesser.quelle": "spring",
    "cat.gewaesser.hafenbecken": "harbor basin",
    "cat.gewaesser.uferlinie": "shoreline",
    "cat.gewaesser.insel": "island",
    "cat.verkehr.feldweg": "field track",
    "cat.verkehr.forstweg": "forest track",
    "cat.verkehr.wirtschaftsweg": "farm track",
    "cat.verkehr.radweg": "bike path",
    "cat.verkehr.gehweg": "footpath",
    "cat.verkehr.privatstrasse": "private road",
    "cat.verkehr.zufahrt": "driveway",
    "cat.bauwerke.mauer": "wall",
    "cat.bauwerke.stuetzmauer": "retaining wall",
    "cat.bauwerke.zaun": "fence",
    "cat.bauwerke.laermschutzwand": "noise barrier",
    "cat.bauwerke.treppe": "stairway",
    "cat.bauwerke.rampe": "ramp",
    "cat.bauwerke.durchlass": "culvert",
    "cat.bauwerke.damm": "embankment",
    "cat.bauwerke.boeschung": "slope",
    "cat.siedlung.wohngebiet": "residential area",
    "cat.siedlung.gewerbegebiet": "commercial area",
    "cat.siedlung.industriegebiet": "industrial area",
    "cat.siedlung.sportplatz": "sports field",
    "cat.siedlung.spielplatz": "playground",
    "cat.siedlung.friedhof": "cemetery",
    "cat.siedlung.campingplatz": "campsite",
    "cat.siedlung.kleingartenanlage": "allotment garden",
    "cat.versorgung.trafostation": "transformer station",
    "cat.versorgung.umspannwerk": "substation",
    "cat.versorgung.rohrleitung": "pipeline",
    "cat.versorgung.wasserbehaelter": "water tank",
    "cat.versorgung.klaeranlage": "sewage treatment plant",
    "cat.versorgung.pumpwerk": "pumping station",
    "cat.versorgung.brunnen": "well",
    "cat.bahn.gleis": "track",
    "cat.bahn.weiche": "switch",
    "cat.bahn.bahnsteig": "platform",
    "cat.bahn.rangieranlage": "marshalling yard",
    "cat.relief.gelaendekante": "terrain edge",
    "cat.relief.aufschuettung": "embankment fill",
    "cat.relief.einschnitt": "cutting",
    "cat.relief.reliefform": "landform",
  ...
  de: {
    ...
    "obj.industrie_gewerbebauwerk": "Industrie- und Gewerbebauwerk",
    "obj.leitung": "Leitung",
    "obj.verkehrsbauwerk": "Verkehrsbauwerk",
    "obj.bahnverkehrsanlage": "Bahnverkehrsanlage",
    "obj.schiffsverkehr": "Schiffsverkehr",
    ...
    "cat.schiffsverkehr.anleger": "Anleger",
    "cat.schiffsverkehr.autofaehre": "Autofähre",

    "obj.gebaeude": "Gebäude",
    "obj.tatsaechliche_nutzung": "Tatsächliche Nutzung",
    "obj.vegetation": "Vegetation",
    "obj.gewaesser": "Gewässer",
    "obj.verkehr": "Verkehr",
    "obj.bauwerke": "Bauwerke",
    "obj.siedlung": "Siedlung",
    "obj.versorgung": "Versorgung",
    "obj.bahn": "Bahn",
    "obj.relief": "Relief",

    "cat.gebaeude.wohngebaeude": "Wohngebäude",
    "cat.gebaeude.geschaeftsgebaeude": "Geschäftsgebäude",
    "cat.gebaeude.industriegebaeude": "Industriegebäude",
    "cat.gebaeude.lagerhalle": "Lagerhalle",
    "cat.gebaeude.garage": "Garage",
    "cat.gebaeude.carport": "Carport",
    "cat.gebaeude.nebengebaeude": "Nebengebäude",
    "cat.gebaeude.schuppen": "Schuppen",
    "cat.gebaeude.gewaechshaus": "Gewächshaus",
    "cat.gebaeude.kirche": "Kirche",
    "cat.gebaeude.schule": "Schule",
    "cat.gebaeude.krankenhaus": "Krankenhaus",
    "cat.gebaeude.sporthalle": "Sporthalle",
    "cat.tatsaechliche_nutzung.acker": "Acker",
    "cat.tatsaechliche_nutzung.gruenland": "Grünland",
    "cat.tatsaechliche_nutzung.wiese": "Wiese",
    "cat.tatsaechliche_nutzung.weide": "Weide",
    "cat.tatsaechliche_nutzung.obstplantage": "Obstplantage",
    "cat.tatsaechliche_nutzung.weinberg": "Weinberg",
    "cat.tatsaechliche_nutzung.baumschule": "Baumschule",
    "cat.tatsaechliche_nutzung.wald": "Wald",
    "cat.tatsaechliche_nutzung.laubwald": "Laubwald",
    "cat.tatsaechliche_nutzung.nadelwald": "Nadelwald",
    "cat.tatsaechliche_nutzung.mischwald": "Mischwald",
    "cat.tatsaechliche_nutzung.heide": "Heide",
    "cat.tatsaechliche_nutzung.moor": "Moor",
    "cat.tatsaechliche_nutzung.sumpf": "Sumpf",
    "cat.tatsaechliche_nutzung.brachflaeche": "Brachfläche",
    "cat.tatsaechliche_nutzung.garten": "Garten",
    "cat.tatsaechliche_nutzung.parkanlage": "Parkanlage",
    "cat.vegetation.einzelbaum": "Einzelbaum",
    "cat.vegetation.baumgruppe": "Baumgruppe",
    "cat.vegetation.baumreihe": "Baumreihe",
    "cat.vegetation.hecke": "Hecke",
    "cat.vegetation.gebuesch": "Gebüsch",
    "cat.vegetation.gehoelz": "Gehölz",
    "cat.gewaesser.fluss": "Fluss",
    "cat.gewaesser.bach": "Bach",
    "cat.gewaesser.see": "See",
    "cat.gewaesser.weiher": "Weiher",
    "cat.gewaesser.teich": "Teich",
    "cat.gewaesser.quelle": "Quelle",
    "cat.gewaesser.hafenbecken": "Hafenbecken",
    "cat.gewaesser.uferlinie": "Uferlinie",
    "cat.gewaesser.insel": "Insel",
    "cat.verkehr.feldweg": "Feldweg",
    "cat.verkehr.forstweg": "Forstweg",
    "cat.verkehr.wirtschaftsweg": "Wirtschaftsweg",
    "cat.verkehr.radweg": "Radweg",
    "cat.verkehr.gehweg": "Gehweg",
    "cat.verkehr.privatstrasse": "Privatstraße",
    "cat.verkehr.zufahrt": "Zufahrt",
    "cat.bauwerke.mauer": "Mauer",
    "cat.bauwerke.stuetzmauer": "Stützmauer",
    "cat.bauwerke.zaun": "Zaun",
    "cat.bauwerke.laermschutzwand": "Lärmschutzwand",
    "cat.bauwerke.treppe": "Treppe",
    "cat.bauwerke.rampe": "Rampe",
    "cat.bauwerke.durchlass": "Durchlass",
    "cat.bauwerke.damm": "Damm",
    "cat.bauwerke.boeschung": "Böschung",
    "cat.siedlung.wohngebiet": "Wohngebiet",
    "cat.siedlung.gewerbegebiet": "Gewerbegebiet",
    "cat.siedlung.industriegebiet": "Industriegebiet",
    "cat.siedlung.sportplatz": "Sportplatz",
    "cat.siedlung.spielplatz": "Spielplatz",
    "cat.siedlung.friedhof": "Friedhof",
    "cat.siedlung.campingplatz": "Campingplatz",
    "cat.siedlung.kleingartenanlage": "Kleingartenanlage",
    "cat.versorgung.trafostation": "Trafostation",
    "cat.versorgung.umspannwerk": "Umspannwerk",
    "cat.versorgung.rohrleitung": "Rohrleitung",
    "cat.versorgung.wasserbehaelter": "Wasserbehälter",
    "cat.versorgung.klaeranlage": "Kläranlage",
    "cat.versorgung.pumpwerk": "Pumpwerk",
    "cat.versorgung.brunnen": "Brunnen",
    "cat.bahn.gleis": "Gleis",
    "cat.bahn.weiche": "Weiche",
    "cat.bahn.bahnsteig": "Bahnsteig",
    "cat.bahn.rangieranlage": "Rangieranlage",
    "cat.relief.gelaendekante": "Geländekante",
    "cat.relief.aufschuettung": "Aufschüttung",
    "cat.relief.einschnitt": "Einschnitt",
    "cat.relief.reliefform": "Reliefform",
